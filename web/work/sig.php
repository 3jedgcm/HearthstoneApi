...
ob_start(); ?>
<input id="send" type="button" value="Download Kml File" onClick="generate()"/>
...
for (var pointId in jsonBasePoint)
{
  ...
  option.text = jsonBasePoint[pointId].GEO_POI_NOM;
  option.id = jsonBasePoint[pointId].GEO_POI_ID;
...
function generate()
{
  ...
  algoDistance()
  dijkstra()
   imprimerChemin(parseInt(document.getElementById("first-select").options[document.getElementById("first-select").selectedIndex].id),parseInt(document.getElementById("second-select").options[document.getElementById("second-select").selectedIndex].id),antecedant,coordinates)
   generateKml()
   console.log(listDistanceArc)
   //console.log(antecedant)
   document.getElementById("send").disabled = true;
   document.getElementById("send").value = "Pour recommencer un traçage, il faut rafraichir la page !"
}
...
function algoDistance()
{
  ...
  d.set(parseInt(document.getElementById("first-select").options[document.getElementById("first-select").selectedIndex].id),0);
  fi.set(0,-1);
  F.push(parseInt(document.getElementById("first-select").options[document.getElementById("first-select").selectedIndex].id));
  let u;
...
function dijkstra()
{
  ...
  let arrivee = parseInt(document.getElementById("second-select").options[document.getElementById("second-select").selectedIndex].id)
  distanceD.set(parseInt(document.getElementById("first-select").options[document.getElementById("first-select").selectedIndex].id),0);
  couleur.set(parseInt(document.getElementById("first-select").options[document.getElementById("first-select").selectedIndex].id),"gris")
  ListSommetAccessible.push(parseInt(document.getElementById("first-select").options[document.getElementById("first-select").selectedIndex].id));
